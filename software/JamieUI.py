...
#                  behavior_folder='/home/antara/JamieExercise/Jamie/behaviors',
#                  emote_file='Emote.json'):
       
#         JamieControl.__init__(self, arduino_port, baud_rate, joint_config_file, emote_file)
...
#                 # Look up the emote value for the expression
